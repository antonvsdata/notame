...
- Feature data: information about the features such as retention time and mass. Results from preprocessing and statistical tests will also be recoreded here. Accessible with ```fData(object)```
