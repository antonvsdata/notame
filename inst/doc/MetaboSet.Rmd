...
- Feature data: information about the feaures such as retention time and mass . Accessible with ```fData(object)```
...
The feature data part usually has a many columns that are created by the peak picking software, but for the sake of this package, the most important are:  
