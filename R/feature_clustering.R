...
#' to fulfill. Each cluster is named after the feature with the highest median peak area (median abundance)
...
#'
#' Assings a cluster ID to all features that are part of a cluster with 2 or more features.
#'
...
#' \code{rt_window}
#'
#' @param data data frame with the abundaces of features, with features as columns
#' @param features data frame with feature information, fData(object)
